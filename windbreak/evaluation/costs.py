...
and the derived per-unit figures are :class:`~windbreak.numeric.types.MoneyMicros`,
...
:class:`~windbreak.forecast.records.ForecastRecord` does not itself guard that
...
def aggregate_research_costs(
    ...
    *,
    ...
    :class:`~windbreak.evaluation.registry.EvaluationInputs.resolutions`). Trade
