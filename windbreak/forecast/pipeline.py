...
def _aggregate_into_record(
    ...
    *,
    ...
    clamp into the point estimate, then assembles the schema-valid record. Live
    eligibility is the AND of the canary gate staying open and the verified
    citation count clearing ``min_verified_citations`` (SPEC S8.8).
