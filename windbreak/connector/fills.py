...
This module is the normative kernel of windbreak's paper-trading realism model:
...
:func:`windbreak.numeric.divide` and
:func:`windbreak.numeric.money_from_price_and_count`.
"""
