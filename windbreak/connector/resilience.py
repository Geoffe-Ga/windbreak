...
_LOGGER = logging.getLogger("windbreak.connector.resilience")
...
def build_default_resilient_caller(
    ...
    *,
    ...
    This is the production composition seam :class:`~windbreak.connector.kalshi.\
client.KalshiClient` uses to turn rate limiting, retries, and the circuit
    ...
    Args:
        ledger_writer: Sink for ``CONNECTOR_HALT`` events; a
            :class:`~windbreak.connector.snapshot.LoggingEventLedgerWriter` when
            None.
