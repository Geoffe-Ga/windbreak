...
3. Categorize changes by dimension (code quality, Python conventions, security, test coverage, etc.)
...
| **Language** | Python Language | Python-specific idioms, type hints, best practices |
...
| **Quality Control** | Quality Control | QC workflows, validation logic, edge case handling |
| **Data** | Data Engineering | Data pipeline quality, preprocessing |
| **Architecture** | Architecture | System design, modularity |
| **CLI/UX** | CLI/UX | Command-line interface, user experience |
...
Specialist reviewers (adapt this list to match your project's actual specialist set):
...
- [CLI/UX Review Specialist](./cli-ux-review-specialist.md)
