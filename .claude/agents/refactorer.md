...
See [python-guidelines.md](../shared/python-guidelines.md) for Python best practices and quality control patterns.
...
**Component**: Risk calculation module with validation

**Breakdown**:

- Class RiskCalculator (configuration, validation parameters)
- Function basic_risk_score (naive implementation, Junior Engineer)
- Function weighted_risk_score (portfolio weighting logic, Implementation Engineer)
- Function optimized_risk_score (performance optimization, Senior Engineer)

**Plan**: Define validation benchmarks, coordinate test writing, review each implementation for correctness and performance.
