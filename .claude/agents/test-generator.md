...
| pytest-runner | Executing tests and verifying coverage |
...
See [python-guidelines.md](../shared/python-guidelines.md) for Python-specific patterns in tests.
...
**Component**: Quality rule validator

**Tests**: Creation (basic functionality), rule evaluation logic, configuration parsing (edge cases), invalid input handling (edge cases), performance with large codebases (integration), plugin integration (integration).
