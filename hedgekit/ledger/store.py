...
Persists a tamper-evident log of :class:`~hedgekit.ledger.events.Event`
...
:data:`~hedgekit.ledger.events.GENESIS_PREV_HASH`). Because any change to a
...
from hedgekit.ledger.events import GENESIS_PREV_HASH
