...
:func:`hedgekit.numeric.divide` with an explicit conservative direction -- costs
:data:`~hedgekit.numeric.RoundingDirection.OVERSTATE_COST` (ceiling, never
understate what a fill costs), the annualized return
:data:`~hedgekit.numeric.RoundingDirection.UNDERSTATE_EQUITY` (floor toward
...
from hedgekit.numeric import MoneyMicros, PricePips, RoundingDirection, divide
...
class NonAnnualizable:
    ...
    :class:`~hedgekit.forecast.records.ForecastRecord` may carry
