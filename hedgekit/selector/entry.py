...
:class:`~hedgekit.selector.types.SelectorInputs` and the already-computed
:class:`~hedgekit.selector.edge.EdgeFigures`; the aggregator assembles them in
...
if TYPE_CHECKING:
    ...
    from hedgekit.selector.types import SelectorInputs
