...
:data:`hedgekit.forecast.triage.PER_FORECAST_BUDGET_MICROS` and its siblings
...
verbatim on :class:`hedgekit.forecast.triage.TriageLedgerWriter`) with
...
:func:`hedgekit.numeric.rounding.divide` so its rounding direction is explicit.
"""
