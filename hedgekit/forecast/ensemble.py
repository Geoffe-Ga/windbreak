...
Aggregates the ensemble's :class:`~hedgekit.forecast.records.ModelVote`s into a
...
*down*
(:attr:`~hedgekit.numeric.rounding.RoundingDirection.UNDERSTATE_EQUITY`) while
Q3 rounds *up*
(:attr:`~hedgekit.numeric.rounding.RoundingDirection.OVERSTATE_COST`), a
