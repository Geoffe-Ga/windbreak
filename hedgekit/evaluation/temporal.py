...
imports the dependency-free :mod:`hedgekit.evaluation.resolution` leaf at
runtime and references :mod:`hedgekit.evaluation.registry`'s carrier types only
under :data:`typing.TYPE_CHECKING`. Because it therefore cannot construct an
:class:`~hedgekit.evaluation.registry.EvaluationInputs`, the reconstruction seam
...
from hedgekit.evaluation.resolution import SettlementEventType
...
if TYPE_CHECKING:
    ...
    from hedgekit.evaluation.resolution import SettlementEvent
...
class RejectionReason(enum.Enum):
    ...
    :class:`~hedgekit.evaluation.resolution.ResolutionOutcome` and
    :class:`~hedgekit.evaluation.resolution.SettlementEventType`.
    """
