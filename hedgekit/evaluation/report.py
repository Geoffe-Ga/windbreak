...
def _render_cost_meter(costs: CostMeter) -> str:
    ...
    Returns:
        ...
        :class:`~hedgekit.numeric.types.MoneyMicros` rendering (or ``n/a`` for a
...
def render_weekly_report(
    *,
    ...
    :class:`~hedgekit.evaluation.costs.CostMeter` money fields, else the fallback).
...
def generate_weekly_report(
    ...
    *,
    ...
    :func:`hedgekit.reports.weekly.maybe_write_weekly`, passing the rendered body
