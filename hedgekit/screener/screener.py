...
:class:`Screener` runs the four :mod:`hedgekit.screener.filters` filters against
an injected :class:`~hedgekit.config.ScreenerConfig` and clock, aggregates their
...
class ScreenResult:
    ...
    Attributes:
        ...
        filters: Each canonical filter name mapped to its
            :class:`~hedgekit.screener.filters.FilterResult`.
    """
