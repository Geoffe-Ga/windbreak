...
:func:`hedgekit.tokens.verify.verify_token` with the two extra guarantees the
Gateway needs:
...
from hedgekit.tokens.verify import verify_token
...
def verify_and_consume(
    ...
    *,
    ...
    :func:`~hedgekit.tokens.verify.verify_token`, whose ``(valid, reason)``
