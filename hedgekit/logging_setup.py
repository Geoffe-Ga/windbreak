"""Structured, secret-redacting logging for hedgekit.
...
clear -- on any logger under the root, not just ``hedgekit`` itself.
"""
...
class RedactionFilter(logging.Filter):
    ...
    routed through the configured handler, not just ``hedgekit``'s own.
    """
