...
string-discriminated :class:`~hedgekit.ledger.events.Event`.
"""
...
class Releaser(Protocol):
    ...
    :meth:`hedgekit.riskkernel.reservations.ReservationLedger.release`.
    """
...
class HumanAckQueue:
    ...
    def expire_due(self, now: int) -> None:
        ...
        :meth:`hedgekit.riskkernel.reservations.ReservationLedger.expire_due`.
