...
:class:`~hedgekit.ledger.events.Event` per cycle. The resulting
...
a :mod:`hedgekit.numeric` scaled integer -- never a float (SPEC S6.1, enforced
...
if TYPE_CHECKING:
    ...
    from hedgekit.alerts.dispatch import AlertDispatcher
...
#: The :class:`~hedgekit.connector.models.NormalizedMarket.jurisdiction_status`
