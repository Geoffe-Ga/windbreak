...
:class:`~hedgekit.ledger.events.Event` (mirroring
:mod:`~hedgekit.riskkernel.reservations`), never a new dataclass subclass. Every
monetary quantity is a :class:`~hedgekit.numeric.types.MoneyMicros`, never a
...
from hedgekit.riskkernel.checks import _ppm_of
from hedgekit.riskkernel.modes import Mode

if TYPE_CHECKING:
    from collections.abc import Callable, Iterable

    from hedgekit.alerts import AlertDispatcher
