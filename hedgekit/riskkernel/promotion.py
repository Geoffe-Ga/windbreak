...
significance override) live in :mod:`hedgekit.riskkernel.process` and build on
these primitives.
...
from hedgekit.riskkernel.modes import _LADDER_RANK, Mode
...
# ``hedgekit/config/schema.py`` is out of this issue's fence, so a dedicated
