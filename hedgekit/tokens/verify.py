...
(:mod:`hedgekit.riskkernel.signing`), preserving the SPEC S5.3 key-isolation
...
#: other hedgekit-signed artifact (SPEC S10.6).
...
class ApprovalTokenClaims:
    ...
    :mod:`hedgekit.numeric` type serialized as its integer ``.value``.
...
def canonical_claims_bytes(claims: ApprovalTokenClaims) -> bytes:
    ...
    verbatim. It reuses :func:`~hedgekit.ledger.events.canonical_json` (sorted
