...
dataclass with no ``hedgekit.config`` dependency.
"""
...
class NtfySink:
    ...
    def send(
        ...
        headers = {
            ...
            "Title": f"hedgekit {alert_type.value}",
...
class SmtpSink:
    ...
    def _build_message(
        ...
        email["Subject"] = f"[hedgekit] {alert_type.value} ({severity.value})"
...
class LogOnlySink:
    ...
    def __init__(self, logger: logging.Logger | None = None) -> None:
        ...
        Args:
            logger: The logger to emit on. Defaults to ``hedgekit.alerts``.
        """
        self._logger = logger or logging.getLogger("hedgekit.alerts")
